...
namespace Nov21stAWSADWeather
{
    ...
    public sealed partial class MainPage : Page
    {
        public MainPage()
        {
            ...
            xnLanguage.DataContext = new LanguageList();
            xnLanguage.DisplayMemberPath = "Name";
            xnLanguage.SelectedValuePath = "Locale";
        ...
        private void Login_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (list1.Count() > 0)
            {
                ...
                Frame.Navigate(typeof(WeatherPage), c.UserName);
            }
            else
        ...
        private void Language_Change(object sender, SelectionChangedEventArgs e)
        {
